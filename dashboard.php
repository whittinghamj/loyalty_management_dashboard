														...
														<tr>
															...
															<td>
																...
																<div class="dropdown-menu dropdown-menu-right" role="menu">
																	...
																	'.( $owner == true ? '<a href="?c=project_edit&id='.$project['id'].'" class="dropdown-item">Edit</a>' : '' ).'

																	'.( $owner == true ? '<a href="actions.php?a=project_delete&id='.$project['id'].'" class="dropdown-item" onclick="return confirm(\'This will delete all data relating to this project including user and project stats and related data. Are you sure?\')">Delete</a>' : '' ).'
																</div>
															</td>
														</tr>
													';
